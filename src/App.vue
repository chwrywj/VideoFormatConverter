  ...
  <el-container>
    ...
    <el-footer>
      <div class="footer">
        ...
        <div class="item" @click="openBrowser('https://toollist.net/convert-video-format-desktop-app')">
          <i class="my-icon my-icon-tech-support"></i>
          <span>{{$t('common.support')}}</span>
        </div>
        <div class="item" @click="openBrowser('https://toollist.net/Donata?from=VideoFormatConversion')">
